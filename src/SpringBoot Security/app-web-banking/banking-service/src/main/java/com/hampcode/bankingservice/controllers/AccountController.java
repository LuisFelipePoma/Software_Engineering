...
public class AccountController {
    ...
    @PostMapping("/user")
    public ResponseEntity<List<AccountResponseDTO>> getAccountByUserId(@RequestParam("email") String email) {
        List<AccountResponseDTO> accounts = accountService.getAccountByUserId(email);
        return new ResponseEntity<>(accounts, HttpStatus.OK);
    }
